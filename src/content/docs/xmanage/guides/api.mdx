...
### <Badge text="GET" variant="note" size="medium" /> /servers/{server}/status
...
### <Badge text="GET" variant="note" size="medium" /> /servers/{server}/logs
...
### <Badge text="GET" variant="note" size="medium" /> /servers/{server}/files/{file}/...
...
### <Badge text="GET" variant="note" size="medium" /> /servers/{server}/backups
> If {file} is a folder, lists files in a directory, otherwise returns file contents as `text/plain`
